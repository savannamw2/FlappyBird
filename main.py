...
from sprites import BG, Plane, Obstacle
...
class Game:
    def __init__(self):
        ...
        bg_height = pygame.image.load(
            '/Users/savanna/Desktop/FlappyBird/graphics/environment/background.png').get_height()
        ...
        self.font = pygame.font.Font(
            '/Users/savanna/Desktop/FlappyBird/graphics/font/BD_Cartoon_Shout.ttf', 30)
        self.score = 0
        self.start_offset = 0

        # menu
        self.menu_surf = pygame.image.load(
            '/Users/savanna/Desktop/FlappyBird/graphics/menu/menu.png').convert_alpha()
        self.menu_rect = self.menu_surf.get_rect(
            center=(WINDOW_WIDTH / 2, WINDOW_HEIGHT / 2))

        # music
        self.music = pygame.mixer.Sound(
            '/Users/savanna/Desktop/FlappyBird/sound/music.wav')
