...
class BG(pygame.sprite.Sprite):
    def __init__(self, groups, scale_factor):
        ...
        bg_image = pygame.image.load(
            '/Users/savanna/Desktop/FlappyBird/graphics/environment/background.png').convert()
...
class Plane(pygame.sprite.Sprite):
    def __init__(self, groups, scale_factor):
        ...
        self.jump_sound = pygame.mixer.Sound(
            '/Users/savanna/Desktop/FlappyBird/sound/jump.wav')
    ...
    def import_frames(self, scale_factor):
        ...
        for i in range(3):
            surf = pygame.image.load(
                f'/Users/savanna/Desktop/FlappyBird/graphics/plane/red{i}.png').convert_alpha()
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, groups, scale_factor):
        ...
        surf = pygame.image.load(
            f'/Users/savanna/Desktop/FlappyBird/graphics/obstacles/{choice((0,1))}.png').convert_alpha()
        self.image = pygame.transform.scale(
            surf, pygame.math.Vector2(surf.get_size()) * scale_factor)
